...
function createWorkspace(overrides: Partial<ProjectPricingMarginWorkspaceView> = {}): ProjectPricingMarginWorkspaceView {
    return {
        ...
        currentReview: {
            ...
            decision: ProjectPricingMarginReviewSummaryDecisionEnum.ConditionalRelease,
        ...
        technicalCostPackage: {
            ...
            taxReviewStatus: ProjectTechnicalCostPackageSummaryTaxReviewStatusEnum.Reviewed,
            highestRiskLevel: ProjectTechnicalCostPackageSummaryHighestRiskLevelEnum.R2,
            blockerCount: 0,
        ...
        bidCommercialProcess: {
            ...
            currentStage: ProjectBidCommercialProcessSummaryCurrentStageEnum.ResultConfirmed,
            decision: ProjectBidCommercialProcessSummaryDecisionEnum.Participate,
            resultStatus: ProjectBidCommercialProcessSummaryResultStatusEnum.Won,
