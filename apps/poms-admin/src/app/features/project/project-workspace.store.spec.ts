...
describe('ProjectWorkspaceStore', () => {
    ...
    const freezeVersionSummary = {
        ...
        rowVersion: 1,
        isCurrent: true,
        status: CommissionRoleAssignmentStatus.Frozen,
        participantsJson: [
            {
                userId: 'user-1',
                displayName: 'Alice',
    ...
    const contractReadiness = {
        ...
        reviewStatus: CommercialDiffReviewStatus.NotRequired,
    ...
    const pricingMarginWorkspace: ProjectPricingMarginWorkspaceView = {
        ...
        currentReview: {
            ...
            isCurrent: true,
            supersedesId: null,
            status: ProjectPricingMarginReviewSummaryStatusEnum.Effective,
            technicalCostPackageId: 'technical-package-1',
            bidCommercialProcessId: 'bid-process-1',
            commercialReleaseBaselineId: 'commercial-baseline-1',
            pricingPath: ProjectPricingMarginReviewSummaryPricingPathEnum.Bid,
            ...
            grossMarginBand: ProjectPricingMarginReviewSummaryGrossMarginBandEnum.Target,
            grossMarginSummary: '毛利达到目标区间。',
            decision: ProjectPricingMarginReviewSummaryDecisionEnum.Released,
    ...
    const pricingMarginReviewHistory = [
        pricingMarginReview,
        {
            ...
            isCurrent: false,
            supersedesId: null,
            status: ProjectPricingMarginReviewSummaryStatusEnum.Superseded,
    ...
    it('loads operating overview and unified accounting into shared state', async () => {
        const overview: ProjectBusinessOutcomeOverviewView = {
            ...
            dataMaturityLevel: OperatingDataMaturityLevel.Insufficient,
            currentActionLevel: OperatingSnapshotActionLevel.Review,
        ...
        const accounting: ProjectUnifiedAccountingView = {
            ...
            unmappedCostSummary: 'Unmapped delivery cost detected',
            dataMaturityLevel: OperatingDataMaturityLevel.Insufficient,
            costActionRecommendation: OperatingSnapshotActionLevel.Review,
            referencedBaselineVersion: 'baseline-v1',
            referencedSnapshotVersion: 'snapshot-v1',
            allowedActions: ['reviewOperatingSignalEvaluation']
        };
    ...
    it('loads commission final settlement into shared state', async () => {
        const finalSettlement: CommissionFinalSettlementView = {
            projectId: 'project-1',
            finalSettlementStatus: CommissionFinalSettlementStatus.PendingFinalSettlement,
            nonRetentionSettlementStatus: CommissionNonRetentionSettlementStatus.SettledNonRetention,
            retentionSettlementStatus: CommissionRetentionSettlementStatus.WaitingRetention,
            retentionDueDate: '2026-05-20',
            retentionDueStatus: CommissionRetentionDueStatus.Pending,
            retentionRequirementSummary: '等待质保金到账',
            retentionReceiptSummary: null,
            departureExceptionSummary: null,
            freezeVersionSummary,
            baselineSelectionSource: BaselineSelectionSource.Original,
            taxImpactSummaryProjection: sensitiveProjection('税务影响待闭合'),
            taxImpactPendingAmountProjection: sensitiveProjection('1200.00'),
            dataMaturityLevel: OperatingDataMaturityLevel.Mature,
            costActionRecommendation: OperatingSnapshotActionLevel.Review,
            currentActionLevel: OperatingSnapshotActionLevel.Block,
    ...
    it('clears all workspace state when clear is called', async () => {
        ...
        const gateOverview: BusinessAccountingFeedbackView = {
            projectId: 'project-1',
            signalLevel: OperatingSignalLevel.Attention,
            currentActionLevel: OperatingSnapshotActionLevel.Review,
            taxImpactSummaryProjection: sensitiveProjection('Tax package is pending closeout'),
            allocationStabilitySummary: null,
            unmappedCostSummary: null,
