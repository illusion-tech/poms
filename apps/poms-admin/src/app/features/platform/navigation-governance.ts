...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, TableModule, ButtonModule, InputTextModule, IconFieldModule, InputIconModule, ToastModule, AdminListShell, AdminListToolbar],
    ...
    template: `
        ...
        <app-admin-list-shell>
            ...
            <div class="border-b border-surface-200 bg-surface-50 px-6 py-5 dark:border-surface-700 dark:bg-surface-950/40">
                <div class="rounded-[8px] border border-amber-300/70 bg-amber-50 px-4 py-4 dark:bg-amber-950/20">
            ...
            <div class="px-6 py-5 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 border-b border-surface-200 dark:border-surface-700">
                <div class="rounded-[8px] border border-surface-200 dark:border-surface-700 px-4 py-4">
                ...
                <div class="rounded-[8px] border border-emerald-200 dark:border-emerald-800 px-4 py-4">
                ...
                <div class="rounded-[8px] border border-rose-200 dark:border-rose-800 px-4 py-4">
