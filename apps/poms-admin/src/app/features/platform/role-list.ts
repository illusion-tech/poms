    ...
    template: `
        ...
        <div class="flex flex-col gap-5">
            <app-admin-table-card>
                <p-button adminToolbarStart icon="pi pi-plus" class="mr-2" severity="secondary" text ariaLabel="新建角色" pTooltip="新建角色" tooltipPosition="top" (onClick)="openCreateDialog()" />
                ...
                <span adminToolbarEnd class="text-sm text-surface-500 dark:text-surface-400">共 {{ platformStore.roles().length }} 个角色</span>
