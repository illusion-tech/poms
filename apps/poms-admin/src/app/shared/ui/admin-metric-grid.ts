...
@Component({
    ...
    template: `
        <section class="card overflow-hidden p-0!">
            <div class="grid grid-cols-1 sm:grid-cols-2" [ngClass]="columns === 3 ? 'xl:grid-cols-3' : 'xl:grid-cols-4'">
                @for (item of items; track item.label) {
                    <div class="min-w-0 border-b border-surface-200 p-5 last:border-b-0 dark:border-surface-800 xl:border-b-0 xl:border-r xl:last:border-r-0">
