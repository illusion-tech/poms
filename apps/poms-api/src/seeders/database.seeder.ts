...
export class DatabaseSeeder extends Seeder {
    async run(em: EntityManager): Promise<void> {
        ...
        await connection.execute(`
            ...
            ('00000000-0000-0000-0000-000000000001', 'admin', '$2b$10$7RUdPn9mRzZHu8aQWDT5Zu0wrexzWNsIMcib8BtFqaM9SDz4.0LhW', '超级管理员', '10000000-0000-4000-8000-000000000001'),
            ('00000000-0000-0000-0000-000000000002', 'viewer', '$2b$10$F7jcXHdsWWNU..qTlkkcB.k9/4efsaoJmTI4.TMyCKfIsNJfq..cm', '只读用户', '10000000-0000-4000-8000-000000000002');
        `);

        await connection.execute(`
            insert into "${schema}"."user_org_membership" ("id", "user_id", "org_unit_id", "membership_type") values
            ('40000000-0000-4000-8000-000000000001', '00000000-0000-0000-0000-000000000001', '10000000-0000-4000-8000-000000000001', 'primary'),
            ('40000000-0000-4000-8000-000000000002', '00000000-0000-0000-0000-000000000002', '10000000-0000-4000-8000-000000000002', 'primary');
        `);

        await connection.execute(`
            insert into "${schema}"."user_role_assignment" ("id", "user_id", "role_id") values
            ('50000000-0000-4000-8000-000000000001', '00000000-0000-0000-0000-000000000001', '30000000-0000-4000-8000-000000000001'),
            ('50000000-0000-4000-8000-000000000002', '00000000-0000-0000-0000-000000000002', '30000000-0000-4000-8000-000000000002');
        `);
        ...
        await connection.execute(`
            ...
            ('60000000-0000-4000-8000-000000000005', '30000000-0000-4000-8000-000000000001', 'project:read'),
            ('60000000-0000-4000-8000-000000000006', '30000000-0000-4000-8000-000000000001', 'project:write'),
            ('60000000-0000-4000-8000-000000000007', '30000000-0000-4000-8000-000000000001', 'project:delete'),
            ('60000000-0000-4000-8000-000000000008', '30000000-0000-4000-8000-000000000001', 'nav:dashboard:view'),
            ('60000000-0000-4000-8000-000000000009', '30000000-0000-4000-8000-000000000001', 'nav:platform:view'),
            ('60000000-0000-4000-8000-000000000010', '30000000-0000-4000-8000-000000000001', 'nav:projects:view'),
            ('60000000-0000-4000-8000-000000000011', '30000000-0000-4000-8000-000000000001', 'nav:contracts:view'),
            ('60000000-0000-4000-8000-000000000012', '30000000-0000-4000-8000-000000000001', 'nav:profile:view'),
            ('60000000-0000-4000-8000-000000000013', '30000000-0000-4000-8000-000000000002', 'project:read'),
            ('60000000-0000-4000-8000-000000000014', '30000000-0000-4000-8000-000000000002', 'nav:dashboard:view'),
            ('60000000-0000-4000-8000-000000000015', '30000000-0000-4000-8000-000000000002', 'nav:projects:view'),
            ('60000000-0000-4000-8000-000000000016', '30000000-0000-4000-8000-000000000002', 'nav:contracts:view'),
            ('60000000-0000-4000-8000-000000000017', '30000000-0000-4000-8000-000000000002', 'nav:profile:view');
        `);
