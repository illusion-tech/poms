...
export class SalesIntelligenceService {
    constructor(private readonly salesIntelligenceRepository: SalesIntelligenceRepository) {}
    ...
    async updateCustomerContact(id: string, input: UpdateCustomerContactRequest, operatorUserId: string): Promise<CustomerContactSummary> {
        const contact = await this.requireContact(id);
        const customer = await this.requireCustomer(contact.customerId);
    ...
    async updateOpportunityStakeholder(id: string, input: UpdateOpportunityStakeholderRequest, operatorUserId: string): Promise<OpportunityStakeholderSummary> {
        const stakeholder = await this.requireStakeholder(id);
    ...
    async updateCompetitorIntelligenceRecord(id: string, input: UpdateCompetitorIntelligenceRecordRequest, operatorUserId: string): Promise<CompetitorIntelligenceRecordSummary> {
        const record = await this.requireCompetitorRecord(id);
    ...
    async updateSalesDiscoveryRecord(id: string, input: UpdateSalesDiscoveryRecordRequest, operatorUserId: string): Promise<SalesDiscoveryRecordSummary> {
        const record = await this.requireDiscoveryRecord(id);
    ...
    private async requireCustomer(id: string): Promise<Customer> {
        const customer = await this.salesIntelligenceRepository.findCustomerById(id);
        if (!customer) {
    ...
    private async requireContact(id: string): Promise<CustomerContact> {
        const contact = await this.salesIntelligenceRepository.findCustomerContactById(id);
        if (!contact) {
    ...
    private async requireStakeholder(id: string): Promise<OpportunityStakeholder> {
        const stakeholder = await this.salesIntelligenceRepository.findOpportunityStakeholderById(id);
        if (!stakeholder) {
    ...
    private async requireCompetitorRecord(id: string): Promise<CompetitorIntelligenceRecord> {
        const record = await this.salesIntelligenceRepository.findCompetitorRecordById(id);
        if (!record) {
    ...
    private async requireDiscoveryRecord(id: string): Promise<SalesDiscoveryRecord> {
        const record = await this.salesIntelligenceRepository.findDiscoveryRecordById(id);
        if (!record) {
