...
import {
    ...
    ProjectHandoverAttachmentChecklistViewDto,
    RefreshProjectHandoverAttachmentChecklistRequestDto
...
export class AttachmentHandoverController {
    ...
    refreshChecklist(
        @Param('handoverId') handoverId: string,
        @Body() body: RefreshProjectHandoverAttachmentChecklistRequestDto,
        @Request() req: RuntimeAuditRequestLike & { user: UserPayload }
    ): Promise<ProjectHandoverAttachmentChecklistView> {
    ...
    createDownloadPackage(
        @Param('handoverId') handoverId: string,
        @Body() body: CreateProjectHandoverAttachmentDownloadPackageRequestDto,
        @Request() req: RuntimeAuditRequestLike & { user: UserPayload }
