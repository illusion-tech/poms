import { Inject, Body, Controller, Get, HttpCode, HttpStatus, Param, Post, Put, Req, Request } from '@nestjs/common';
...
export class AttachmentUploadSessionController {
    ...
    create(@Body() body: CreateAttachmentUploadSessionRequestDto, @Request() req: RuntimeAuditRequestLike & { user: UserPayload }): Promise<AttachmentUploadSessionSummary> {
    ...
    createUploadTarget(@Param('id') id: string, @Body() body: CreateAttachmentUploadTargetRequestDto, @Request() req: { user: UserPayload }): Promise<AttachmentUploadTarget> {
    ...
    async proxyUploadObject(@Param('id') id: string, @Req() req: IncomingMessage & { user: UserPayload }): Promise<AttachmentUploadTargetResult> {
    ...
    complete(@Param('id') id: string, @Body() body: CompleteAttachmentUploadSessionRequestDto, @Request() req: RuntimeAuditRequestLike & { user: UserPayload }): Promise<AttachmentSummary> {
    ...
    @ApiOkResponse({ type: AttachmentUploadSessionDto })
    abort(@Param('id') id: string, @Body() body: AbortAttachmentUploadSessionRequestDto, @Request() req: RuntimeAuditRequestLike & { user: UserPayload }): Promise<AttachmentUploadSessionSummary> {
