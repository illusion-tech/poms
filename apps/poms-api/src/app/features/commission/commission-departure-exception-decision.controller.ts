import type { CommissionDepartureExceptionDecisionSummary, UserPayload } from '@poms/shared-contracts';
import { CommissionDepartureExceptionDecisionSummaryDto, CreateCommissionDepartureExceptionDecisionRequestDto } from '@poms/api-contracts';
import { Inject, Body, Controller, Param, Post, Request } from '@nestjs/common';
...
export class CommissionDepartureExceptionDecisionController {
    ...
    createDepartureExceptionDecision(@Param('projectId') projectId: string, @Request() req: { user: UserPayload }, @Body() body: CreateCommissionDepartureExceptionDecisionRequestDto): Promise<CommissionDepartureExceptionDecisionSummary> {
