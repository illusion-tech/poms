import type { ArbitrateCommissionFreezeDisputeResult, CommissionFreezeDisputeDetailView, SubmitCommissionFreezeDisputeResult, UserPayload } from '@poms/shared-contracts';
import { ArbitrateCommissionFreezeDisputeRequestDto, ArbitrateCommissionFreezeDisputeResultDto, CommissionFreezeDisputeDetailViewDto, SubmitCommissionFreezeDisputeRequestDto, SubmitCommissionFreezeDisputeResultDto } from '@poms/api-contracts';
...
export class CommissionFreezeDisputeController {
    ...
    submitCommissionFreezeDispute(@Request() req: { user: UserPayload }, @Body() body: SubmitCommissionFreezeDisputeRequestDto): Promise<SubmitCommissionFreezeDisputeResult> {
    ...
    arbitrateCommissionFreezeDispute(@Param('id') id: string, @Request() req: { user: UserPayload }, @Body() body: ArbitrateCommissionFreezeDisputeRequestDto): Promise<ArbitrateCommissionFreezeDisputeResult> {
