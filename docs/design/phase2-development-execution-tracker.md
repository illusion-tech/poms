...
| `EX-06` | `L1/L2` | 执行期成本记录对象与来源映射落地                                            | `Done` | `Codex`   | `EX-05`                   | `phase2-project-actual-cost-records.md`、`phase2-cost-source-to-project-record-mapping.md`                                                         | 成本记录、来源映射、最小命令读写链、测试与文档回写完成       | corrective checkpoint 已收口第一批 drift；`EX-06B1 ~ EX-06B4` 已完成 `PAYMENT_FACT / INVOICE / EXPENSE / PROCUREMENT` 映射、finance-scoped 读侧、OpenAPI / client、migration-check 与 `poms-api-e2e`；后续累计 / 分摊 / 税务吸收口径转入 `EX-07` |
