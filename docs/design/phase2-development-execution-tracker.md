...
| `EX-03D`   | `EX-03` | poms-admin 用户管理前端补全                                                | `Done`        | `Copilot` | `EX-03B`                  | 用户详情页、用户信息编辑、secondary org 展示完成 | 用户详情弹窗对接 GET /users/:id；编辑信息弹窗对接 PATCH /users/:id；分配组织弹窗支持主/副组织；PlatformStore 补 loadUserDetail/updateUser；构建通过 |
