...
| `EX-07A`   | `EX-07`   | 建立分摊、税务影响、实时 / 期末快照模型                                    | `Doing` | `Claude`  | `EX-06`                   | 快照与税务相关表结构完成                                                                       | G1 = Pass 2026-04-14；`handover_rebaseline_record_id` 字段以 nullable uuid 创建，FK 约束延迟到 EX-08（E2 例外）                                                                                                                                                                                               |
