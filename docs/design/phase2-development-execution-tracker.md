...
| `EX-06` | `L1/L2` | 执行期成本记录对象与来源映射落地                                            | `Doing` | `Cursor`  | `EX-05`                   | `phase2-project-actual-cost-records.md`、`phase2-cost-source-to-project-record-mapping.md`                                                         | 成本记录、来源映射、最小命令读写链、测试与文档回写完成       | 设计一致性评估进行中（冻结表/DDL 与 ADR-012、migration 口径）；此前已有实现合入，待评估后再定收口或变更                               |
...
| `EX-06A`   | `EX-06` | 建立统一成本记录对象与来源映射表结构                                       | `Doing` | `Cursor`  | `EX-05`                   | 成本记录与映射 migration 完成                    | 评估中：表结构、migration 与 `table-structure-freeze` / `schema-ddl-design` 一致性                                                                              |
| `EX-06B`   | `EX-06` | 实现成本记录命令链与来源映射规则                                           | `Doing` | `Cursor`  | `EX-06A`                  | 写侧链路与最小读侧链路完成                       | 评估中：命令链、DTO 与来源映射规则相对设计文档是否需调整                                                                                                        |
| `EX-06C`   | `EX-06` | 完成成本记录测试与文档回写                                                 | `Doing` | `Cursor`  | `EX-06B`                  | 测试、设计回写完成                               | 评估中：单测/E2E 与文档回写是否需随设计结论更新                                                                                                                 |
