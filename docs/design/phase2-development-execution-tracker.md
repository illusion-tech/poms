...
4. 若任务执行中发现范围变化，应先回写上位控制文档，再调整本板。
5. 子任务进入 `Done` 不等于父任务自动 `Done`；父任务仍需在全部子任务完成且完成定义满足后再关闭。
...
| ------- | ------- | --------------------------------------------------------------------------- | ------------- | ------ | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | -------------------------- |
| `EX-01` | `GOV`   | `OrgUnit` 持久化、命令、查询与最小管理闭环                                  | `Not Started` | `TBD`  | 无                        | `platform-governance/org-unit-design.md`                                                                                                           | migration、entity、query、command、guard、测试、文档回写完成 | 平台治理补齐第一步         |
...
| ---------- | ------- | -------------------------------------------------------------------------- | ------------- | ------ | ------------------------- | ---------------------------------------------- | --------------------- |
| `EX-01A`   | `EX-01` | 建立 `OrgUnit` 相关 migration、表结构与索引                                | `Not Started` | `TBD`  | 无                        | 表结构、索引、约束落地并可执行 migration       | 持久化起点            |
| `EX-01B`   | `EX-01` | 实现 `OrgUnit` entity、repository、query API                               | `Not Started` | `TBD`  | `EX-01A`                  | 列表、树查询、详情查询可用                     | 读侧最小闭环          |
| `EX-01C`   | `EX-01` | 实现 `OrgUnit` command、guard、测试与文档回写                              | `Not Started` | `TBD`  | `EX-01B`                  | 创建、更新、启停、测试、文档回写完成           | `EX-01` 收口          |
...
| ------------ | ---------- | -------------------------------------------- | --------------- | ------------- | ------------------------ | ----------------------- | ---------------------------------------------------------------------------------------------- |
| `EX-01A-01`  | `EX-01A`   | 明确 `OrgUnit` 逻辑表、字段组、主外键与索引  | `Design Freeze` | `Not Started` | 无                       | 表结构清单              | 已回看 `org-unit-design.md`、`data-model-prerequisites.md`、`table-structure-freeze-design.md` |
| `EX-01A-02`  | `EX-01A`   | 编写 `OrgUnit` migration SQL                 | `Migration`     | `Not Started` | `EX-01A-01`              | migration 文件          | 本地可执行，表、索引、约束完整                                                                 |
| `EX-01A-03`  | `EX-01A`   | 回写 `schema-ddl-design.md` 与执行板         | `Docs`          | `Not Started` | `EX-01A-02`              | 文档回写                | DDL 文档与 tracker 状态同步                                                                    |
| `EX-01B-01`  | `EX-01B`   | 建立 `OrgUnit` entity / mapping              | `Backend`       | `Not Started` | `EX-01A-02`              | entity / mapping 代码   | 字段与 migration 对齐，无隐式漂移                                                              |
| `EX-01B-02`  | `EX-01B`   | 实现 `OrgUnit` repository 与树查询           | `Backend`       | `Not Started` | `EX-01B-01`              | repository / query 代码 | 列表、详情、树查询闭环可用                                                                     |
| `EX-01B-03`  | `EX-01B`   | 补 `OrgUnit` 查询测试                        | `Test`          | `Not Started` | `EX-01B-02`              | 单测 / e2e              | 覆盖树查询与关键失败路径                                                                       |
