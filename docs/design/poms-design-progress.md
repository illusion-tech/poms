...
- `L3` 第一切片 `EX-08`：已完成 `EX-08A0` 实施准备，新增 `ex-08-contract-handover-gate-baseline.md` 并将 `EX-08` 拆成 `EX-08A1 ~ EX-08C3` 的可执行链路；当前只表示 `G1` 输入冻结完成，后续应从 `EX-08A1` 开始落地移交与再基线化核心 DDL，并优先清理 `EX-07` 延迟的 `handover_rebaseline_record_id` FK 例外。
