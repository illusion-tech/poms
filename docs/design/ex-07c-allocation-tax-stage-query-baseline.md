...
- **本次明确不做**:
  ...
  - 不补 `handover_rebaseline_record_id` 外键；继续沿用 EX-07A / EX-07B 例外，待 EX-08 主表落地后补齐。
...
| ------------ | ----- | ------------------------------------ | ----------- | ------------------- | ---------------- | ---------------------------------------------------------------------------------------------- |
| EX-07C-E01   | E2    | `handover_rebaseline_record_id` 外键 | Codex       | EX-08 owner         | EX-08 完成后     | 沿用 EX-07A-E01 / EX-07B-E01；字段保留，FK 等 `contract_handover_rebaseline_record` 落地后补加 |
