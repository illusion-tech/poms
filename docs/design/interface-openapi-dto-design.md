...
| `claimLeadOwner`          | `POST /leads/{id}:claim`                  | `expectedVersion`                                                                     | 普通线索基础字段、关闭 / 转项目字段                          | `targetId`、`leadOwnerAssignmentRecordId`、`previousOwnerUserId`、`previousOwnerOrgId`、`newOwnerUserId`、`newOwnerOrgId`、`assignmentType`、`businessStatusAfter`                    |
| `assignLeadOwner`         | `POST /leads/{id}:assignOwner`            | `ownerUserId`、`ownerOrgId?`、`reason`、`expectedVersion`                             | 普通线索基础字段、关闭 / 转项目字段                          | `targetId`、`leadOwnerAssignmentRecordId`、`previousOwnerUserId`、`previousOwnerOrgId`、`newOwnerUserId`、`newOwnerOrgId`、`assignmentType`、`businessStatusAfter`                    |
