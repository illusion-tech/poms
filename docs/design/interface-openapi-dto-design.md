...
| `registerPaymentFactCostRecord`                      | `POST /project-actual-cost-records:registerPaymentFact`             | `paymentRecordId`、`projectId`、`costDescription`、`evidenceSummary`、`expectedVersion`                                                     | 前端直接回填支付金额、支付日期、`recordStatus`、`sourceType/sourceId`  | `targetId`、`paymentRecordId`、`businessStatusAfter`、`resultStatus`                                                                                                                                                                                                                                                                                               |
