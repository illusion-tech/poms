...
5. 若操作本身会产生稳定的申请 / 审批 / 争议 / 变更对象，应直接资源化建模，例如 `POST /commission-role-change-requests`，而不是继续追加 action suffix。
...
| `createCommissionRoleChangeRequest` | `POST /commission-role-change-requests`          | `commissionRoleAssignmentId`、`reason`、`comment`、`attachmentIds`、`expectedVersion`          | 直接改当前冻结版本、脱离来源 assignment 引用的裸提交                  | `targetId`、`commissionRoleAssignmentId`、`approvalRecordId`、`businessStatusAfter`                                                                                                                                            |
...
| `registerPaymentFactCostRecord`                      | `POST /project-actual-cost-records/register-payment-fact`           | `paymentRecordId`、`projectId`、`costDescription`、`evidenceSummary`、`expectedVersion`                                                     | 前端直接回填支付金额、支付日期、`recordStatus`、`sourceType/sourceId`     | `targetId`、`paymentRecordId`、`businessStatusAfter`、`resultStatus`                                                                                                                                                                                                                                                                                               |
| `registerInvoiceCostRecord`                          | `POST /project-actual-cost-records/register-invoice`                | `invoiceRecordId`、`projectId`、`costDescription`、`evidenceSummary`、`taxImpactSummary`、`expectedVersion`                                 | 前端直接回填发票金额、验票状态、`recordStatus`、`sourceType/sourceId`     | `targetId`、`invoiceRecordId`、`businessStatusAfter`、`resultStatus`                                                                                                                                                                                                                                                                                               |
| `registerExpenseCostRecord`                          | `POST /project-actual-cost-records/register-expense`                | `expenseRecordId`、`projectId`、`costDescription`、`evidenceSummary`、`taxImpactSummary`、`expectedVersion`                                 | 前端直接回填费用金额、费用日期、`recordStatus`、`sourceType/sourceId`     | `targetId`、`expenseRecordId`、`businessStatusAfter`、`resultStatus`                                                                                                                                                                                                                                                                                               |
| `registerProcurementCostRecord`                      | `POST /project-actual-cost-records/register-procurement`            | `payableRecordId`、`projectId`、`costDescription`、`evidenceSummary`、`taxImpactSummary`、`expectedVersion`                                 | 前端直接回填采购承诺金额、来源状态、`recordStatus`、`sourceType/sourceId` | `targetId`、`payableRecordId`、`businessStatusAfter`、`resultStatus`                                                                                                                                                                                                                                                                                               |
...
| `replaceLaborCostRecord`                             | `POST /project-actual-cost-records/{id}:replace`                    | `supersedesRecordId`、`rateVersionId`、`reason`、`comment`、`expectedVersion`                                                               | 直接物理删除原记录、整包覆盖原审计字段                                    | `targetId`、`replacementRecordId`、`recalculationCandidateId`、`resultStatus`                                                                                                                                                                                                                                                                                      |
