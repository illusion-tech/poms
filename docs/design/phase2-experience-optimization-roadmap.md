...
| 编号     | 任务                                   | 当前状态      | 备注                   |
| -------- | -------------------------------------- | ------------- | ---------------------- |
| `L3-T01` | 补“合同到移交的承接工作区”详细草案     | `Not Started` | 依赖 `L1`、`L2` 输入   |
| `L3-T02` | 补“项目移交强节点”详细草案             | `Not Started` | 依赖 `L3-T01`          |
| `L3-T03` | 补“提成角色与权重冻结绑定移交”详细草案 | `Not Started` | 依赖 `L3-T02`          |
| `L3-T04` | 明确移交处一次收口口径                 | `Not Started` | 依赖 `L3-T01 ~ L3-T03` |
