...
| Domain         | Capability                      | Canonical Route                                  | Current Implemented Route                                 | Current Design Route                             | Authority              | Drift Type                 | Action                                                                                                          | Batch | Status                 |
| -------------- | ------------------------------- | ------------------------------------------------ | --------------------------------------------------------- | ------------------------------------------------ | ---------------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------- | ----- | ---------------------- |
| `project-cost` | `registerPaymentFactCostRecord` | `POST /projects/{projectId}/actual-cost-records` | `POST /project-actual-cost-records/register-payment-fact` | `POST /projects/{projectId}/actual-cost-records` | `ADR-015` + `EX-15E2B` | `resourceization-required` | 统一为 `ProjectActualCostRecord` collection create；移除 body `projectId`，改用 `costType=PAYMENT_FACT` variant | `B2`  | `implementation-drift` |
| `project-cost` | `registerInvoiceCostRecord`     | `POST /projects/{projectId}/actual-cost-records` | `POST /project-actual-cost-records/register-invoice`      | `POST /projects/{projectId}/actual-cost-records` | `ADR-015` + `EX-15E2B` | `resourceization-required` | 统一为 `ProjectActualCostRecord` collection create；移除 body `projectId`，改用 `costType=INVOICE` variant      | `B2`  | `implementation-drift` |
| `project-cost` | `registerExpenseCostRecord`     | `POST /projects/{projectId}/actual-cost-records` | `POST /project-actual-cost-records/register-expense`      | `POST /projects/{projectId}/actual-cost-records` | `ADR-015` + `EX-15E2B` | `resourceization-required` | 统一为 `ProjectActualCostRecord` collection create；移除 body `projectId`，改用 `costType=EXPENSE` variant      | `B2`  | `implementation-drift` |
| `project-cost` | `registerProcurementCostRecord` | `POST /projects/{projectId}/actual-cost-records` | `POST /project-actual-cost-records/register-procurement`  | `POST /projects/{projectId}/actual-cost-records` | `ADR-015` + `EX-15E2B` | `resourceization-required` | 统一为 `ProjectActualCostRecord` collection create；移除 body `projectId`，改用 `costType=PROCUREMENT` variant  | `B2`  | `implementation-drift` |
| `project-cost` | `registerLaborCostRecord`       | `POST /projects/{projectId}/actual-cost-records` | `POST /project-cost/register-labor-cost-record`           | `POST /projects/{projectId}/actual-cost-records` | `ADR-015` + `EX-15E2B` | `resourceization-required` | 统一为 `ProjectActualCostRecord` collection create；去掉 `expectedVersion`，改用 `costType=LABOR` variant       | `B2`  | `implementation-drift` |
| `project-cost` | `replaceLaborCostRecord`        | `POST /project-actual-cost-records/{id}:replace` | `POST /project-cost/replace-labor-cost-record`            | `POST /project-actual-cost-records/{id}:replace` | `ADR-015` + `EX-15E2B` | `resourceization-required` | path `{id}` 作为 superseded record identity SSOT；request 不再重复 `supersedesRecordId`                         | `B2`  | `implementation-drift` |
