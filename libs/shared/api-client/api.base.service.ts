...
export class BaseService {
    ...
    public configuration: PomsApiConfiguration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: PomsApiConfiguration) {
        this.configuration = configuration || new PomsApiConfiguration();
